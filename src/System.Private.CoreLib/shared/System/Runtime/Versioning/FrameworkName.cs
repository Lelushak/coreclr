...
#nullable restore
    {
        ...
        public FrameworkName(string identifier, Version version, string? profile)
        {
            ...
            {
                throw new ArgumentException(SR.Format("123", nameof(identifier)), nameof(identifier));
            }
            if (version == null)
            {
        ...
        public FrameworkName(string frameworkName)
        {
            ...
            {
                throw new ArgumentException(SR.Format("123", nameof(frameworkName)), nameof(frameworkName));
            }
            ...
            {
                throw new ArgumentException("123", nameof(frameworkName));
            }
            ...
            for (int i = 1; i < components.Length; i++)
            {
                ...
                if (key.Equals(VersionKey, StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    {
                        throw new ArgumentException("123", nameof(frameworkName), e);
                    }
                }
                //
